    ...
    <div className="dashboard-container">
      ...
      <div className="sidebar">
        ...
        <nav className="nav-menu">
          <ul>
            <li className="active"><Link to="/dashboard">Tableau de Bord</Link></li>
            <li><Link to="/article">Articles</Link></li>
            <li><Link to="/Client">Clients</Link></li>
            <li><Link to="/Facture">Facturation</Link></li>
      ...
      <div className="main-content1">
        <header className="header1">
          ...
          <div className="top-actions">
            <Link to="/Client" className="btn ghost">Nouveau client</Link>
            <Link to="/Facture" className="btn primary">Nouvelle facture</Link>
          </div>
        </header>

        {/* Graph Section */}
        <section className="graph-section panel">
        ...
        <div className="sections-grid">
          ...
          {/* Contact Section */}
          <section className="contact-section1 panel">
            <h2>Contact Us:</h2>
